...
function plugin_formvalidation_install() {
   ...
   if (!TableExists("glpi_plugin_formvalidation_forms")) {
		$query = "CREATE TABLE `glpi_plugin_formvalidation_forms` (
	                  ...
	                  `css_selector` VARCHAR(200) NOT NULL,
   ...
   if (!TableExists("glpi_plugin_formvalidation_fields")) {
		$query = "CREATE TABLE `glpi_plugin_formvalidation_fields` (
	                  ...
	                  `css_selector_value` VARCHAR(500) NULL DEFAULT NULL,
	                  `css_selector_altvalue` VARCHAR(500) NULL DEFAULT NULL,
	                  `css_selector_errorsign` VARCHAR(500) NULL DEFAULT NULL,
	                  `css_selector_mandatorysign` VARCHAR(500) NULL DEFAULT NULL,
	                  `is_active` TINYINT(1) NOT NULL DEFAULT '1',
      ...
      $query = "INSERT INTO `glpi_plugin_formvalidation_fields` (`id`, `name`, `forms_id`, `css_selector_value`, `css_selector_altvalue`, `css_selector_errorsign`, `css_selector_mandatorysign`, `is_active`, `show_mandatory`, `show_mandatory_if`, `formula`, `comment`, `date_mod`)
                VALUES (1,  'Name', 1, 'div>table>tbody>tr:eq(1)>td:eq(1) input[name=\\\"name\\\"]', NULL, 'div>table>tbody>tr:eq(1)>td:eq(1)', 'div>table>tbody>tr:eq(1)>td:eq(0)', 1, 1, NULL, NULL, NULL, NULL),
                       ...
                       (6,  'Error sign CSS selector', 3, 'div>table>tbody>tr:eq(5)>td:eq(1) input[name=\\\"css_selector_errorsign\\\"]', NULL, 'div>table>tbody>tr:eq(5)>td:eq(1)', 'div>table>tbody>tr:eq(5)>td:eq(0)', 1, 1, NULL, NULL, NULL, NULL),
                       (7,  'Mandatory sign CSS selector', 3, 'div>table>tbody>tr:eq(6)>td:eq(1) input[name=\\\"css_selector_mandatorysign\\\"]', NULL, 'div>table>tbody>tr:eq(6)>td:eq(1)', 'div>table>tbody>tr:eq(6)>td:eq(0)', 1, 0, '#6', NULL, NULL, NULL),
                       (8,  'Force Mandatory sign', 3, 'div>table>tbody>tr:eq(8)>td:eq(1)>span input[name=\\\"show_mandatory\\\"]', NULL, 'div>table>tbody>tr:eq(8)>td:eq(1)', 'div>table>tbody>tr:eq(8)>td:eq(0)', 1, 0, NULL, NULL, NULL, NULL),
